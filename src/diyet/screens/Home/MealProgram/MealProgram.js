...
const MealProgram = ({ navigation }) => {
  ...
  function getMorningMealProgram() {
    ...
    const reference = database().ref("/diyet/FoodProgram/Morning/" + user.uid);
    reference
      .on('value', snapshot => {
  ...
  function getNoonMealProgram() {
    ...
    const reference = database().ref("/diyet/FoodProgram/Noon/" + user.uid);
    reference
      .on('value', snapshot => {
  ...
  function getEveningMealProgram() {
    ...
    const reference = database().ref("/diyet/FoodProgram/Evening/" + user.uid);
    reference
      .on('value', snapshot => {
